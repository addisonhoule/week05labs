...
//I copied this from lab solution on github to test code.
		...
		vendingMachine.addItem(item, itemSlot.getQuantity(), "A1", itemSlot.getPrice());
		vendingMachine.addItem(item1, itemSlot1.getQuantity(), "A2", itemSlot1.getPrice());
		vendingMachine.addItem(item2, itemSlot2.getQuantity(), "A3", itemSlot2.getPrice());
		...
		System.out.println("\nBuying:  A1");
		Return newReturn = vendingMachine.choice(money, "A1");	
		newReturn.describe();
		System.out.println("Buying:  A2");
		newReturn = vendingMachine.choice(newReturn.change, "A2");	
		newReturn.describe();
		System.out.println("Buying:  A3");
		newReturn = vendingMachine.choice(newReturn.change, "A3");	
		newReturn.describe();
